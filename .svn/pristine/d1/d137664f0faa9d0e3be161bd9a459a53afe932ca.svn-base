...
var DygraphOptions = (function() {
    ...
    a.prototype.getForSeries = function(c, e) {
        if (e === this.dygraph_.highlightSet_) {
...
Dygraph.prototype.createInterface_ = function() {
    ...
    this.mouseOutHandler_ = function(f) {
        ...
        if (Dygraph.isElementContainedBy(d, b.graphDiv) && !Dygraph.isElementContainedBy(c, b.graphDiv)) {
            b.mouseOut_(f)
        }
    };
...
Dygraph.prototype.updateSelection_ = function(d) {
    ...
    if (this.selPoints_.length > 0) {
        ...
        for (h = 0; h < this.selPoints_.length; h++) {
            ...
            n.strokeStyle = e;
            n.fillStyle = e;
            m(this.g, o.name, n, b, o.canvasy, e, a)
        }
        n.restore();
...
Dygraph.isElementContainedBy = function(b, a) {
    if (a === null || b === null) {
        return false
    }
    while (b && b !== a) {
...
Dygraph.Plugins.Legend = (function() {
    ...
    c.prototype.activate = function(j) {
        ...
        if (l && null !== l) {
            ...
            var i = {position: "absolute", zIndex: 10, left: (j.size().width - f - 2) + "px", lineHeight: "normal", overflow: "hidden"};
...
Dygraph.Plugins.RangeSelector = (function() {
    ...
    a.prototype.resize_ = function() {
        ...
        var b = this.getOption_("xAxisHeight") || (this.getOption_("axisLabelFontSize") + 2 * this.getOption_("axisTickSize"));
