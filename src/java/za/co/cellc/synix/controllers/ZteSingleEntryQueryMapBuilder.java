 ...
 */
public class ZteSingleEntryQueryMapBuilder extends QueryMapBuilder {
    ...
    public Map<String, String> getQueriesMap() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ZteSingleEntryQueryMapBuilder.class.getName()).log(Level.SEVERE, null, ex);
