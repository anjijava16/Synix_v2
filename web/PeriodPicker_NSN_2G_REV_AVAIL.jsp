...
<html>
                ...
                <tr>
                    <td style="text-align:left">                           
                        ...
                        <input class="comboPeriodClass" data-dojo-type="dijit/form/ComboBox"
                               ...
                               name="state"
                               id="PeriodPicker_NSN_2G_REV_AVAIL_Period"/>

                    </td>
                    <td style="text-align:center">
                        <label for="From Date:">From:</label>
                        <input type="text" name="fromDate" id="PeriodPicker_NSN_2G_REV_AVAIL_FromDate" 
                               data-dojo-type="dijit/form/DateTextBox"
                               constraints={datePattern:'dd/MM/yyyy'}
                               required="true"/>
                        <label for="To Date:">&nbsp &nbsp &nbsp To:</label>
                        <input type="text" name="toDate" id="PeriodPicker_NSN_2G_REV_AVAIL_ToDate" 
                               data-dojo-type="dijit/form/DateTextBox"
                               constraints={datePattern:'dd/MM/yyyy'}
    ...
    <div id="PeriodPicker_NSN_2G_REV_AVAIL_Result" style="width: 100%;display: block;"></div>
