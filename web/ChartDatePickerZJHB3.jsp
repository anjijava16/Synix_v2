...
<html>
    ...
    <body>
                ...
                <tr>
                    <td style="text-align:left">                           
                        ...
                        <input class="comboPeriodClass" data-dojo-type="dijit/form/ComboBox"
                               ...
                               name="state"
                               id="comboPeriodIDZJHB3" />

                    </td>
                    <td style="text-align:center">
                        <label for="From Date:">From:</label>
                        <input type="text" name="fromDate" id="filterFromDateZJHB3" 
                               data-dojo-type="dijit/form/DateTextBox"
                               constraints={datePattern:'dd/MM/yyyy'}
                               required="true"/>
                        <label for="To Date:">&nbsp &nbsp &nbsp To:</label>
                        <input type="text" name="toDate" id="filterToDateZJHB3" 
                               data-dojo-type="dijit/form/DateTextBox"
                               constraints={datePattern:'dd/MM/yyyy'}
        ...
        <div id="chartResult2ZJHB3" style="width: 100%;display: block;"></div>
        <div id="chartResultZJHB3" style="width: 100%"></div>
    </body>
</html>
