 ...
 */
var TOOLTIP_DISTANCE = 150;
var TOOLTIP_Y_LOCATION = 111;
...
//            g = g[1];
            ...
            i = i.call(h, this);
            h = a.series;
            this.distance = m(h.tooltipOptions.distance, TOOLTIP_DISTANCE);
            ...
            D(c, "tooltipRefresh", {text: i, x: f + c.plotLeft, y: 0 + c.plotTop, borderColor: k})
//            D(c, "tooltipRefresh", {text: i, x: f + c.plotLeft, y: g + c.plotTop, borderColor: k})
//            console.log("g=" + g + ", c.plotTop=" + c.plotTop);
        }, updatePosition: function(a) {
            var b = this.chart,
                    c = this.label, c = (this.options.positioner || this.getPosition).call(this, c.width, c.height, a);
//            console.log("c.x=" + c.x + ", c.y=" + c.y+"a.plotY=" + a.plotY + ", b.plotTop=" + b.plotTop);
            this.move(u(c.x), u(c.y), a.plotX + b.plotLeft, a.plotY + b.plotTop)
//            this.move(u(c.x), u(TOOLTIP_Y_LOCATION), a.plotX + b.plotLeft, TOOLTIP_Y_LOCATION)
