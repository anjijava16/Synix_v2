...
define("dojox/widget/SortList",["dijit","dojo","dojox","dojo/require!dijit/layout/_LayoutWidget,dijit/_Templated"],function(_1,_2,_3){
    ...
    _2.declare("dojox.widget.SortList",[_1.layout._LayoutWidget,_1._Templated],{
        title:"",
        heading:"",
        descending:true,
        selected:null,
        ...
        postCreate:function(){
            if(this.store){
                ...
                var _5={
                    onItem:_2.hitch(this,"_addItem"),
                    onComplete:_2.hitch(this,"onSort")
                    };
